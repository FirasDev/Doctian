  ...
  void loadAnalyses() async {
    ...
    if (response.statusCode == 200) {
      ...
      if (jsonResponse != null) {
        setState(() {
          analyses = (jsonResponse as List)
              .map((data) => new Analysis.patientFromJson(data))
              .toList();
        });
        print("- Analyses Length : " + analyses.length.toString());
      }
    } else {
      // setState(() {
      //   _isLoading = false;

...
class UserAppointmentRequest extends StatefulWidget {
  final List<Appointment> appointments;
  UserAppointmentRequest({Key key, @required this.appointments})
      : super(key: key);
  @override
  _UserAppointmentRequestState createState() => _UserAppointmentRequestState();
}

class _UserAppointmentRequestState extends State<UserAppointmentRequest> {

...
import 'package:hello_world/ui/user/screens/widgets/_DoctorRegisterFinal.dart';
...
class _DoctorRegisterState extends State<DoctorRegister> {
  ...
  String _textDate(DateTime date) {
    if (date != null) {
      return "Date : " + DateFormat('E d/MM/y').format(date);
      // date.year.toString() +
      // "/" +
      // date.month.toString() +
      // "/" +
    ...
    return "Select Start Work Date";
  }

  completeRegister(String name, String lastname, String idCarte,
      String medicalLicenseNumber, DateTime date, String speciality) async {
    ...
    //   'startWorkDate': date.toIso8601String(),
    // };

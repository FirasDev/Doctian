...
class SelectPatientForDiagnostics extends StatefulWidget {
  
  @override
  _SelectPatientForDiagnosticsState createState() => _SelectPatientForDiagnosticsState();
...
class _SelectPatientForDiagnosticsState extends State<SelectPatientForDiagnostics> {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      height: MediaQuery.of(context).size.height/1.65,
              child: Column(
        children: <Widget>[
          Text("Select your patient",style: TextStyle(color: Colors.black,fontSize: 23.0),),
          SizedBox(height: 10,),
          new Container(
